  ...
  public ExperimentProvenanceDTO build(UriInfo uriInfo, ResourceRequest resourceRequest, Project project, String mlId)
    ...
    if (dto.isExpand()) {
      try {
        ...
        Collection<FootprintFileState> filesReadHits = provenanceController.provAppFootprintList(project, builder,
        ...
        Collection<FootprintFileState> filesOutputHits = provenanceController.provAppFootprintList(project, builder,
