...
public class RESTCodes {
  ...
  public enum DatasetErrorCode implements RESTErrorCode {
    ...
    ATTACH_XATTR_ERROR(75, "Failed to attach Xattr.", Response.Status.INTERNAL_SERVER_ERROR);
  ...
  public enum FeaturestoreErrorCode implements RESTErrorCode {
    ...
    CLONE_ID_NOT_PROVIDED(15, "Clone Id not provided despite requesting to clone feature group version",
        Response.Status.BAD_REQUEST),
    DEPENDENCY_INODE_NOT_FOUND(16, "Could not find an inode for the file name provided as a dependency",
        Response.Status.BAD_REQUEST),
    TRAINING_DATASET_ALREADY_EXISTS(17, "The provided training dataset name already exists",
        Response.Status.BAD_REQUEST),
    NO_PRIMARY_KEY_SPECIFIED(18, "A feature group or training dataset must have a primary key specified",
        Response.Status.BAD_REQUEST),
    CERTIFICATES_NOT_FOUND(19, "Could not find user certificates for authenticating with Hive Feature Store",
        Response.Status.INTERNAL_SERVER_ERROR),
    COULD_NOT_INITIATE_HIVE_CONNECTION(20, "Could not initiate connecton to Hive Server",
        Response.Status.INTERNAL_SERVER_ERROR),
    HIVE_UPDATE_STATEMENT_ERROR(21, "Hive Update Statement failed",
        Response.Status.INTERNAL_SERVER_ERROR),
    HIVE_READ_QUERY_ERROR(22, "Hive Read Query failed",
        Response.Status.INTERNAL_SERVER_ERROR),
