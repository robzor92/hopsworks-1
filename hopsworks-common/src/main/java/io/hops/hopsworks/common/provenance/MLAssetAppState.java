...
public class MLAssetAppState {
  ...
  public MLAssetAppState() {
  }
  
  public static MLAssetAppState unknown() {
    MLAssetAppState state = new MLAssetAppState();
  ...
  public void setAppState(Provenance.AppState appState, Long time) throws ServiceException {
    switch (appState) {
      case SUBMITTED:
      ...
      case KILLED:
        ...
        break;
      default:
        throw new ServiceException(RESTCodes.ServiceErrorCode.ERROR_EXECUTING_REMOTE_COMMAND, Level.INFO,
