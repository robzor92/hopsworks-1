  ...
  describe 'model' do
    ...
    context 'with authentication create, get' do
      ...
      it "should run three experiments and check items, count and href" do
        ...
        create_model_job(@project, experiment_2)
        ...
        create_model_job(@project, experiment_3)
  ...
  describe 'models sort, filter, offset and limit' do
    context 'with authentication' do
      ...
      describe "Models filter" do
        ...
        it "should get 0 model with name_eq cifar" do
          get_models(@project[:id], "?filter_by=name_eq:cifar")
          expect_status(200)
          expect(json_body[:items]).to be nil
        end
        it "should get 0 model with name_like cifar" do
